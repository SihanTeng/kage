...
- **No new dependencies** unless they remove more code than they add. The
  browser driver is chromedp; keep leakless and go-rod out of the graph so
  `go install` and Windows AV stay clean.
